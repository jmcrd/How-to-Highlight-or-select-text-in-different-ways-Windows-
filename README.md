...
From my GitHub If you want to download the file I am using in this tutorial and save it to your local computer using Google Chrome, you follow these steps and You can also use your own file.
   ...
   2. On the repository page, click on In Windows How to Select Or Highlight Text in Different Ways this link will take you to another repository, and on this page, you'll find a green "Code" button. Click on it to reveal a dropdown menu.
   ...
   7. open the folder by double-clicking on it. you should have the entire file, and for more details on how to do this, read the README file or pdf File where I've written out the steps in simple terms.
   8. open this file. 
...
### You can also use Keyboard Shortcuts 
   ...
   - select the text, press the "Ctrl" key on your keyboard and, while holding it down, press the "C" key. This action will copy the selected text.

   - After copying, you can paste the text into another location. To do this, navigate to the desired location left click on the line. press the "Ctrl" key on your keyboard and, while holding it down, press the "V" key. This action will paste the selected text.
...
- Once you've moved the file to the desired location, release the left mouse button. The file will be dropped into its new position.
...
### Additional Tips:
   - Alternatively, you can also cut the text or file.
   - To cut the text you select Right-click on the selected content to open the context menu.
   - In the context menu, select the "Cut" option. You may see an icon representing cutting (often a pair of scissors).
   - The selected content is now cut from its original location and copied to the clipboard, ready to be pasted elsewhere.
   - You can also use ctrl + x to cut the file or text and paste it as you like.
   ...
   - now you can paste the text or file wherever you want, by right-clicking or Ctrl + V Shortcut.


### Pro Tips:
   - The "Ctrl + C", Ctrl + X, and Ctrl + V shortcuts work universally across many applications and Windows operating systems.

   -  You can use "Ctrl + C" to copy not only text but also files and folders within file managers or explorer windows.
   - By using "Ctrl + C," you can quickly and easily copy text or files, saving time and effective when working on your computer.

   - By using "Ctrl + X," you can quickly and easily cut text or files from the original area it can be pasted anywhere you like, the main advantage is saving time and effective when working on your computer.

   - Pressing "Ctrl + V" is a widely used keyboard shortcut for pasting copied or cut text, files, or other content.

The primary difference between "Ctrl + C" and "Ctrl + X" keyboard shortcuts.

   - "Ctrl + C" is used to copy selected text or files without removing them from their original location.
   - When you use "Ctrl + C," a copy of the selected content is placed in the clipboard, allowing you to paste it elsewhere. The original content remains in its current location after copying.
...
6. **Shift + Home/End:**
   ...
   - Holding `Shift`, press `Home` to select from the cursor to the start of the line.
   - Holding `Shift`, press `End` to select from the cursor to the end of the line.
